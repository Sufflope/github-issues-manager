...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProtectedBranch'
        db.create_table(u'core_protectedbranch', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='protected_branches', to=orm['core.Repository'])),
            ('name', self.gf('django.db.models.fields.TextField')(db_index=True)),
            ('require_status_check', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_status_check_include_admins', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_up_to_date', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_approved_review', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_approved_review_include_admins', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('etag', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['ProtectedBranch'])

        # Adding field 'Repository.protected_branches_fetched_at'
        db.add_column(u'core_repository', 'protected_branches_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.protected_branches_etag'
        db.add_column(u'core_repository', 'protected_branches_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProtectedBranch'
        db.delete_table(u'core_protectedbranch')

        # Deleting field 'Repository.protected_branches_fetched_at'
        db.delete_column(u'core_repository', 'protected_branches_fetched_at')

        # Deleting field 'Repository.protected_branches_etag'
        db.delete_column(u'core_repository', 'protected_branches_etag')
