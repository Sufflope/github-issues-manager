...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabelType.is_metric'
        db.add_column(u'core_labeltype', 'is_metric',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Repository.main_metric'
        db.add_column(u'core_repository', 'main_metric',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='+', unique=True, null=True, to=orm['core.LabelType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabelType.is_metric'
        db.delete_column(u'core_labeltype', 'is_metric')

        # Deleting field 'Repository.main_metric'
        db.delete_column(u'core_repository', 'main_metric_id')
