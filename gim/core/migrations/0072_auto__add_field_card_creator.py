...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.creator'
        db.add_column(u'core_card', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cards', null=True, to=orm['core.GithubUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.creator'
        db.delete_column(u'core_card', 'creator_id')
