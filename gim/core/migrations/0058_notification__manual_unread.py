...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GithubNotification.manual_unread'
        db.add_column(u'core_githubnotification', 'manual_unread',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GithubNotification.manual_unread'
        db.delete_column(u'core_githubnotification', 'manual_unread')
