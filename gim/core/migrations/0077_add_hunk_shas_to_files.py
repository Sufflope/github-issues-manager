...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullRequestFile.hunk_shas'
        db.add_column(u'core_pullrequestfile', 'hunk_shas',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommitFile.hunk_shas'
        db.add_column(u'core_commitfile', 'hunk_shas',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullRequestFile.hunk_shas'
        db.delete_column(u'core_pullrequestfile', 'hunk_shas')

        # Deleting field 'CommitFile.hunk_shas'
        db.delete_column(u'core_commitfile', 'hunk_shas')
