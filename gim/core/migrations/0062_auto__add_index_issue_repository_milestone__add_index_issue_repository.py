...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Issue', fields ['repository', 'milestone']
        db.create_index(u'core_issue', ['repository_id', 'milestone_id'])

        # Adding index on 'Issue', fields ['repository', 'assignee']
        db.create_index(u'core_issue', ['repository_id', 'assignee_id'])

        # Adding index on 'Issue', fields ['repository', 'state']
        db.create_index(u'core_issue', ['repository_id', 'state'])

        # Adding index on 'Issue', fields ['repository', 'milestone', 'state']
        db.create_index(u'core_issue', ['repository_id', 'milestone_id', 'state'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'Issue', fields ['repository', 'milestone', 'state']
        db.delete_index(u'core_issue', ['repository_id', 'milestone_id', 'state'])

        # Removing index on 'Issue', fields ['repository', 'state']
        db.delete_index(u'core_issue', ['repository_id', 'state'])

        # Removing index on 'Issue', fields ['repository', 'assignee']
        db.delete_index(u'core_issue', ['repository_id', 'assignee_id'])

        # Removing index on 'Issue', fields ['repository', 'milestone']
        db.delete_index(u'core_issue', ['repository_id', 'milestone_id'])
    ...
    models = {
        ...
        'core.repository': {
            ...
            'main_metric': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'+'", 'unique': 'True', 'null': 'True', 'to': "orm['core.LabelType']"}),
