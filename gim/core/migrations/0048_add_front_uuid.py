...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IssueComment.front_uuid'
        db.add_column(u'core_issuecomment', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommitComment.front_uuid'
        db.add_column(u'core_commitcomment', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.front_uuid'
        db.add_column(u'core_label', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.front_uuid'
        db.add_column(u'core_issue', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Milestone.front_uuid'
        db.add_column(u'core_milestone', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PullRequestComment.front_uuid'
        db.add_column(u'core_pullrequestcomment', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueComment.front_uuid'
        db.delete_column(u'core_issuecomment', 'front_uuid')

        # Deleting field 'CommitComment.front_uuid'
        db.delete_column(u'core_commitcomment', 'front_uuid')

        # Deleting field 'Label.front_uuid'
        db.delete_column(u'core_label', 'front_uuid')

        # Deleting field 'Issue.front_uuid'
        db.delete_column(u'core_issue', 'front_uuid')

        # Deleting field 'Milestone.front_uuid'
        db.delete_column(u'core_milestone', 'front_uuid')

        # Deleting field 'PullRequestComment.front_uuid'
        db.delete_column(u'core_pullrequestcomment', 'front_uuid')
