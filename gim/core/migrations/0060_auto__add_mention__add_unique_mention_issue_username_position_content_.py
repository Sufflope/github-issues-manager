...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_mention', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mentions', to=orm['core.Issue'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mentions', null=True, to=orm['core.GithubUser'])),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('position', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('core', ['Mention'])

        # Adding unique constraint on 'Mention', fields ['issue', 'username', 'position', 'content_type', 'object_id']
        db.create_unique(u'core_mention', ['issue_id', 'username', 'position', 'content_type_id', 'object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Mention', fields ['issue', 'username', 'position', 'content_type', 'object_id']
        db.delete_unique(u'core_mention', ['issue_id', 'username', 'position', 'content_type_id', 'object_id'])

        # Deleting model 'Mention'
        db.delete_table(u'core_mention')
