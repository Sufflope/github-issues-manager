...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_issue_assignees')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['core.issue'], null=False)),
            ('githubuser', models.ForeignKey(orm['core.githubuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'githubuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field assignees on 'Issue'
        db.delete_table(db.shorten_name(u'core_issue_assignees'))
