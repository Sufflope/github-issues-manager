...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PullRequestReview'
        db.create_table(u'core_pullrequestreview', (
            ...
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', to=orm['core.Issue'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', to=orm['core.GithubUser'])),
            ...
            ('head_sha', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=256, null=True, blank=True)),
            ('comments_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('displayable', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
        ))
        db.send_create_signal('core', ['PullRequestReview'])

        # Adding field 'Issue.pr_reviews_fetched_at'
        db.add_column(u'core_issue', 'pr_reviews_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.pr_review_state'
        db.add_column(u'core_issue', 'pr_review_state',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.pr_reviews_activated'
        db.add_column(u'core_repository', 'pr_reviews_activated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PullRequestReview'
        db.delete_table(u'core_pullrequestreview')

        # Deleting field 'Issue.pr_reviews_fetched_at'
        db.delete_column(u'core_issue', 'pr_reviews_fetched_at')

        # Deleting field 'Issue.pr_review_state'
        db.delete_column(u'core_issue', 'pr_review_state')

        # Deleting field 'Repository.pr_reviews_activated'
        db.delete_column(u'core_repository', 'pr_reviews_activated')
