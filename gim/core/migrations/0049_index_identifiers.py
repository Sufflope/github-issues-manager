...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CommitCommentEntryPoint', fields ['position']
        db.create_index(u'core_commitcommententrypoint', ['position'])

        # Adding index on 'CommitCommentEntryPoint', fields ['commit_sha']
        db.create_index(u'core_commitcommententrypoint', ['commit_sha'])

        # Adding index on 'CommitCommentEntryPoint', fields ['path']
        db.create_index(u'core_commitcommententrypoint', ['path'])

        # Adding index on 'Label', fields ['name']
        db.create_index(u'core_label', ['name'])

        # Adding index on 'PullRequestCommentEntryPoint', fields ['original_position']
        db.create_index(u'core_pullrequestcommententrypoint', ['original_position'])

        # Adding index on 'PullRequestCommentEntryPoint', fields ['position']
        db.create_index(u'core_pullrequestcommententrypoint', ['position'])

        # Adding index on 'PullRequestCommentEntryPoint', fields ['original_commit_sha']
        db.create_index(u'core_pullrequestcommententrypoint', ['original_commit_sha'])

        # Adding index on 'PullRequestCommentEntryPoint', fields ['commit_sha']
        db.create_index(u'core_pullrequestcommententrypoint', ['commit_sha'])

        # Adding index on 'PullRequestCommentEntryPoint', fields ['path']
        db.create_index(u'core_pullrequestcommententrypoint', ['path'])

        # Adding index on 'CommitFile', fields ['sha']
        db.create_index(u'core_commitfile', ['sha'])

        # Adding index on 'PullRequestFile', fields ['tree']
        db.create_index(u'core_pullrequestfile', ['tree'])

        # Adding index on 'PullRequestFile', fields ['sha']
        db.create_index(u'core_pullrequestfile', ['sha'])


    def backwards(self, orm):
        # Removing index on 'PullRequestFile', fields ['sha']
        db.delete_index(u'core_pullrequestfile', ['sha'])

        # Removing index on 'PullRequestFile', fields ['tree']
        db.delete_index(u'core_pullrequestfile', ['tree'])

        # Removing index on 'CommitFile', fields ['sha']
        db.delete_index(u'core_commitfile', ['sha'])

        # Removing index on 'PullRequestCommentEntryPoint', fields ['path']
        db.delete_index(u'core_pullrequestcommententrypoint', ['path'])

        # Removing index on 'PullRequestCommentEntryPoint', fields ['commit_sha']
        db.delete_index(u'core_pullrequestcommententrypoint', ['commit_sha'])

        # Removing index on 'PullRequestCommentEntryPoint', fields ['original_commit_sha']
        db.delete_index(u'core_pullrequestcommententrypoint', ['original_commit_sha'])

        # Removing index on 'PullRequestCommentEntryPoint', fields ['position']
        db.delete_index(u'core_pullrequestcommententrypoint', ['position'])

        # Removing index on 'PullRequestCommentEntryPoint', fields ['original_position']
        db.delete_index(u'core_pullrequestcommententrypoint', ['original_position'])

        # Removing index on 'Label', fields ['name']
        db.delete_index(u'core_label', ['name'])

        # Removing index on 'CommitCommentEntryPoint', fields ['path']
        db.delete_index(u'core_commitcommententrypoint', ['path'])

        # Removing index on 'CommitCommentEntryPoint', fields ['commit_sha']
        db.delete_index(u'core_commitcommententrypoint', ['commit_sha'])

        # Removing index on 'CommitCommentEntryPoint', fields ['position']
        db.delete_index(u'core_commitcommententrypoint', ['position'])
