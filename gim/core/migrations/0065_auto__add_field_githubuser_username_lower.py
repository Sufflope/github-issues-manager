...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GithubUser.username_lower'
        db.add_column(u'core_githubuser', 'username_lower',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Set username_lower for all existing users
        for user in orm.GithubUser.objects.all():
            user.username_lower = user.username.lower()
            user.save(update_fields=['username_lower'])


    def backwards(self, orm):
        # Deleting field 'GithubUser.username_lower'
        db.delete_column(u'core_githubuser', 'username_lower')
