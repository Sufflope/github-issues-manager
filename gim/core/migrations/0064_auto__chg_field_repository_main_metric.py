...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repository.main_metric'
        db.alter_column(u'core_repository', 'main_metric_id', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, to=orm['core.LabelType'], unique=True))

    def backwards(self, orm):

        # Changing field 'Repository.main_metric'
        db.alter_column(u'core_repository', 'main_metric_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.LabelType']))
