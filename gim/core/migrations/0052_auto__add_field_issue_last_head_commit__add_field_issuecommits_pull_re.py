...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.last_head_commit'
        db.add_column(u'core_issue', 'last_head_commit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='', null=True, to=orm['core.Commit']),
                      keep_default=False)

        # Adding field 'IssueCommits.pull_request_head_at'
        db.add_column(u'core_issuecommits', 'pull_request_head_at',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.last_head_commit'
        db.delete_column(u'core_issue', 'last_head_commit_id')

        # Deleting field 'IssueCommits.pull_request_head_at'
        db.delete_column(u'core_issuecommits', 'pull_request_head_at')
