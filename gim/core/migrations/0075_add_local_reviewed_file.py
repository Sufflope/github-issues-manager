...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalReviewedFile'
        db.create_table(u'core_localreviewedfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='local_reviewed_files', to=orm['core.Repository'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='local_reviewed_files', to=orm['core.GithubUser'])),
            ('path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('patch_sha', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('reviewed_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True)),
        ))
        db.send_create_signal('core', ['LocalReviewedFile'])

        # Adding unique constraint on 'LocalReviewedFile', fields ['repository', 'author', 'path', 'patch_sha']
        db.create_unique(u'core_localreviewedfile', ['repository_id', 'author_id', 'path', 'patch_sha'])

        # Adding field 'PullRequestFile.patch_sha'
        db.add_column(u'core_pullrequestfile', 'patch_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CommitFile.patch_sha'
        db.add_column(u'core_commitfile', 'patch_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'LocalReviewedFile', fields ['repository', 'author', 'path', 'patch_sha']
        db.delete_unique(u'core_localreviewedfile', ['repository_id', 'author_id', 'path', 'patch_sha'])

        # Deleting model 'LocalReviewedFile'
        db.delete_table(u'core_localreviewedfile')

        # Deleting field 'PullRequestFile.patch_sha'
        db.delete_column(u'core_pullrequestfile', 'patch_sha')

        # Deleting field 'CommitFile.patch_sha'
        db.delete_column(u'core_commitfile', 'patch_sha')
    ...
    models = {
        ...
        'core.localreviewedfile': {
            'Meta': {'unique_together': "[('repository', 'author', 'path', 'patch_sha')]", 'object_name': 'LocalReviewedFile'},
            ...
            'reviewed_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True'})
        },
        'core.mention': {
