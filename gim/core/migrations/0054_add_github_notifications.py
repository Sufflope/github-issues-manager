...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GithubNotification'
        db.create_table(u'core_githubnotification', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='github_notifications', to=orm['core.GithubUser'])),
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Repository'])),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Issue'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, null=True, blank=True)),
            ('reason', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, null=True, blank=True)),
            ('issue_number', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('unread', self.gf('django.db.models.fields.BooleanField')(db_index=True)),
            ('last_read_at', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('previous_updated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('ready', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['GithubNotification'])

        # Adding field 'GithubUser.github_notifications_fetched_at'
        db.add_column(u'core_githubuser', 'github_notifications_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GithubUser.github_notifications_etag'
        db.add_column(u'core_githubuser', 'github_notifications_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.fetch_minimal_done'
        db.add_column(u'core_repository', 'fetch_minimal_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GithubNotification'
        db.delete_table(u'core_githubnotification')

        # Deleting field 'GithubUser.github_notifications_fetched_at'
        db.delete_column(u'core_githubuser', 'github_notifications_fetched_at')

        # Deleting field 'GithubUser.github_notifications_etag'
        db.delete_column(u'core_githubuser', 'github_notifications_etag')

        # Deleting field 'Repository.fetch_minimal_done'
        db.delete_column(u'core_repository', 'fetch_minimal_done')
