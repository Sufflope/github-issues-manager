...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'LabelType', fields ['repository', 'is_metric']
        db.create_index(u'core_labeltype', ['repository_id', 'is_metric'])


    def backwards(self, orm):
        # Removing index on 'LabelType', fields ['repository', 'is_metric']
        db.delete_index(u'core_labeltype', ['repository_id', 'is_metric'])
