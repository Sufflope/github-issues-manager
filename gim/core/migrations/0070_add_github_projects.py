...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_project', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['core.Repository'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['core.GithubUser'])),
            ...
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True, null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('columns_fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('columns_etag', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('body_html', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Project'])

        # Adding unique constraint on 'Project', fields ['repository', 'number']
        db.create_unique(u'core_project', ['repository_id', 'number'])

        # Adding model 'Card'
        db.create_table(u'core_card', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('github_status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True)),
            ('github_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True)),
            ('column', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cards', to=orm['core.Column'])),
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cards', null=True, to=orm['core.Issue'])),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('note_html', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Card'])

        # Adding model 'Column'
        db.create_table(u'core_column', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('github_status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, db_index=True)),
            ('github_id', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='columns', to=orm['core.Project'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('cards_fetched_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('cards_etag', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Column'])

        # Adding field 'Repository.projects_fetched_at'
        db.add_column(u'core_repository', 'projects_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.projects_etag'
        db.add_column(u'core_repository', 'projects_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['repository', 'number']
        db.delete_unique(u'core_project', ['repository_id', 'number'])

        # Deleting model 'Project'
        db.delete_table(u'core_project')

        # Deleting model 'Card'
        db.delete_table(u'core_card')

        # Deleting model 'Column'
        db.delete_table(u'core_column')

        # Deleting field 'Repository.projects_fetched_at'
        db.delete_column(u'core_repository', 'projects_fetched_at')

        # Deleting field 'Repository.projects_etag'
        db.delete_column(u'core_repository', 'projects_etag')
