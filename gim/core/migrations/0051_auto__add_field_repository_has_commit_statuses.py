...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.has_commit_statuses'
        db.add_column(u'core_repository', 'has_commit_statuses',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.has_commit_statuses'
        db.delete_column(u'core_repository', 'has_commit_statuses')
