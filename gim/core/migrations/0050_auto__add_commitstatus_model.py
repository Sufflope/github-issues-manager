...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommitStatus'
        db.create_table(u'core_commitstatus', (
            ...
            ('repository', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_statuses', to=orm['core.Repository'])),
            ('commit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commit_statuses', to=orm['core.Commit'])),
            ...
            ('state', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, db_index=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('context', self.gf('django.db.models.fields.TextField')(default='default', db_index=True)),
            ('target_url', self.gf('django.db.models.fields.URLField')(max_length=512, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['CommitStatus'])

        # Adding field 'Issue.last_head_status'
        db.add_column(u'core_issue', 'last_head_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding index on 'Issue', fields ['head_sha']
        db.create_index(u'core_issue', ['head_sha'])

        # Adding field 'Commit.last_status'
        db.add_column(u'core_commit', 'last_status',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Commit.commit_statuses_fetched_at'
        db.add_column(u'core_commit', 'commit_statuses_fetched_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Commit.commit_statuses_etag'
        db.add_column(u'core_commit', 'commit_statuses_etag',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'Issue', fields ['head_sha']
        db.delete_index(u'core_issue', ['head_sha'])

        # Deleting model 'CommitStatus'
        db.delete_table(u'core_commitstatus')

        # Deleting field 'Issue.last_head_status'
        db.delete_column(u'core_issue', 'last_head_status')

        # Deleting field 'Commit.last_status'
        db.delete_column(u'core_commit', 'last_status')

        # Deleting field 'Commit.commit_statuses_fetched_at'
        db.delete_column(u'core_commit', 'commit_statuses_fetched_at')

        # Deleting field 'Commit.commit_statuses_etag'
        db.delete_column(u'core_commit', 'commit_statuses_etag')
