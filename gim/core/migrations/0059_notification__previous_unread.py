...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GithubNotification.previous_unread'
        db.add_column(u'core_githubnotification', 'previous_unread',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Set `previous_unread` for existing notifications
        orm.GithubNotification.objects.update(previous_unread=models.F('unread'))


    def backwards(self, orm):
        # Deleting field 'GithubNotification.previous_unread'
        db.delete_column(u'core_githubnotification', 'previous_unread')
