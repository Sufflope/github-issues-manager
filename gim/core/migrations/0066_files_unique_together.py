...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CommitFile', fields ['repository', 'commit', 'sha', 'path']
        db.create_unique(u'core_commitfile', ['repository_id', 'commit_id', 'sha', 'path'])

        # Adding unique constraint on 'PullRequestFile', fields ['repository', 'issue', 'tree', 'sha', 'path']
        db.create_unique(u'core_pullrequestfile', ['repository_id', 'issue_id', 'tree', 'sha', 'path'])


    def backwards(self, orm):
        # Removing unique constraint on 'PullRequestFile', fields ['repository', 'issue', 'tree', 'sha', 'path']
        db.delete_unique(u'core_pullrequestfile', ['repository_id', 'issue_id', 'tree', 'sha', 'path'])

        # Removing unique constraint on 'CommitFile', fields ['repository', 'commit', 'sha', 'path']
        db.delete_unique(u'core_commitfile', ['repository_id', 'commit_id', 'sha', 'path'])
