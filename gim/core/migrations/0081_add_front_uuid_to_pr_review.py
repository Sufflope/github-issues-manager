...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullRequestReview.front_uuid'
        db.add_column(u'core_pullrequestreview', 'front_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullRequestReview.front_uuid'
        db.delete_column(u'core_pullrequestreview', 'front_uuid')
