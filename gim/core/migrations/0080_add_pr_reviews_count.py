...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.pr_reviews_count'
        db.add_column(u'core_issue', 'pr_reviews_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.pr_reviews_count'
        db.delete_column(u'core_issue', 'pr_reviews_count')
